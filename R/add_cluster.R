...
#' Using the __stats__ package,it calculates a hierarchical
...
#' all its defaults), then it calculates a tree (with [stats::hclust()] and all
#' its defaults), and finally cuts the tree in `n` groups (with
#' [stats::cutree()]).
#' 
