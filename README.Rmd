...
__fgeo.tool__ helps you to import and manipulate ForestGEO data. It provides functions that can expect different classes of ForestGEO data and also reexports from other packages useful tools to wrangle data in general.
